...
/**
 * @extends ServiceEntityRepository<MedicalExamination>
 *
...
class MedicalExaminationRepository extends ServiceEntityRepository
{
    ...
    public function save(MedicalExamination $entity, bool $flush = false): void
    {
    ...
    public function remove(MedicalExamination $entity, bool $flush = false): void
    {
